...
#
# Generated by Vivado on Fri Nov 27 15:16:36 -0800 2020
...
# Script info
echo -e "clk_wiz_0.sh - Script generated by export_simulation (Vivado v2019.2 (64-bit)-id)\n"
...
compile()
{
  ...
  vlogan -work xil_defaultlib $vlogan_opts +v2k +incdir+"$ref_dir/../../../ipstatic" \
    "$ref_dir/../../../../SpaceSynth_All.srcs/sources_1/ip/clk_wiz_0_1/clk_wiz_0_clk_wiz.v" \
    "$ref_dir/../../../../SpaceSynth_All.srcs/sources_1/ip/clk_wiz_0_1/clk_wiz_0.v" \
  2>&1 | tee -a vlogan.log
