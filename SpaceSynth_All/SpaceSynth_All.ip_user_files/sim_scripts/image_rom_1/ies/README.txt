...
#
# Generated by export_simulation on Mon Dec 07 21:17:40 -0800 2020
#
################################################################################
...
'-reset_run' switch to the './image_rom_1.sh' script.

./image_rom_1.sh -reset_run
...
./image_rom_1.sh -noclean_files

For more information on the script, please type './image_rom_1.sh -help'.
