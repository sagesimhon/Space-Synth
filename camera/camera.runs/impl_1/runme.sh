...
HD_PWD='/home/sage/camera/camera.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log clean_top_level.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source clean_top_level.tcl -notrace
