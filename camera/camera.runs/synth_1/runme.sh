...
HD_PWD='/home/sage/test_camera/test_camera.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log clean_top_level.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source clean_top_level.tcl
